...
public class Lumber {
    ...
    public Lumber(String description, String finishing, String wood_type, String quality, int size,
                      int width, int length, int quantity, int reserved_quantity){
     ...
     * @param all_delivered
     */
    public Lumber(int schnittID,String lager,String description,String finishing, String wood_type, String quality,
