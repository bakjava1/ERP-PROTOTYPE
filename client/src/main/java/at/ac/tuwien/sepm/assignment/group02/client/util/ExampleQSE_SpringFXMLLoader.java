 ...
 */
@Component
public class ExampleQSE_SpringFXMLLoader {

    private static final Logger LOG = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());
    private final ApplicationContext applicationContext;

    @Autowired
    public ExampleQSE_SpringFXMLLoader(ApplicationContext applicationContext) {
    ...
    public <TLoad> TLoad load(String pathToFXMLFile, Class<TLoad> loadType) throws IOException {
        return this.load(ExampleQSE_SpringFXMLLoader.class.getResourceAsStream(pathToFXMLFile), loadType);
    }
    ...
    public Object load(String pathToFXMLFile) throws IOException {
        return this.load(ExampleQSE_SpringFXMLLoader.class.getResourceAsStream(pathToFXMLFile));
    }
    ...
    public synchronized <TLoad, TController> FXMLWrapper<TLoad, TController> loadAndWrap(
            ...
            Class<TLoad> loadType,
            Class<TController> controllerType) throws IOException {
        return this.loadAndWrap(ExampleQSE_SpringFXMLLoader.class.getResourceAsStream(pathToFXMLFile), loadType, controllerType);
    }
